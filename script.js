document.addEventListener("DOMContentLoaded", () => {
  ...
  if (btn) {
    btn.addEventListener("click", () => {
      ...
      if (clickCount === 1) {
        window.open("https://s.shopee.co.id/9Uvl47ZlDD", "_blank");  /* ===GANTI # DENGAN LINK DI ANTARA "dan"==== */
      } else {
...
===================== */
function goCek() {
  window.open("https://s.lazada.co.id/s.ZVb5lx?cc&atype=pdp-i7832852647-s14688992549", "_blank");   /* ===GANTI # DENGAN LINK DI ANTARA "dan"==== */
}
